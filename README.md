# genpark-browser-native-wasm-microcontainer-node-runtime-skill
...
> **GenPark AI Agent Skill** -- Browser-native WebAssembly microcontainer node runtime (Bolt.new WebContainers style)
